...
buildList()
		...
		function buildList(){
			...
			var url = 'http://hbihub.com/mydocuments/task-list/'
			var urledit = 'http://hbihub.com/mydocuments/edit/'
...
function deleteItem(item){
			...
			//fetch(`http://127.0.0.1:8000/mydocuments/task-delete/${item.id}/`,
		        fetch(`http://hbihub.com/mydocuments/task-delete/${item.id}/`,
			{
				method:'DELETE',
				headers:{
...
function changePublishItem(item){
			...
			//fetch(`http://127.0.0.1:8000/mydocuments/task-update/${item.id}/`,
		        fetch(`http://hbihub.com/mydocuments/task-update/${item.id}/`,
			{
				method:'POST',
				headers:{
					'Content-type':'application/json',
