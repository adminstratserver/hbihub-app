...
class RegistrationView(View):
    ...
    def post(self, request):
        ...
        send_mail(mail_subject, message, 'davidtang@hengbao.com', [email])
...
class RequestActivationCode(View):
    ...
    def post(self, request):
        ...
        if checkmember0 != 0:
            ...
            # to_email = form.cleaned_data.get('email')
            send_mail(mail_subject, message, 'davidtang@hengbao.com', [username])
...
def activate(request, uidb64, token):
    ...
    if user is not None and account_activation_token.check_token(user, token):
        ...
        send_mail(mail_subject, message, 'davidtang@hengbao.com', ['davidtang@hengbao.com'])
